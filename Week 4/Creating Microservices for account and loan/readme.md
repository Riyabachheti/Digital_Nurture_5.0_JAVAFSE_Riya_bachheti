# Microservices with API Gateway – Hands-on Exercise

## Exercise Title

**2. Microservices with API gateway – Creating Microservices for account and loan**
...
- Open command prompt in account folder and build using:
